...
namespace BlueWolf\MinecraftToolkit\Livewire;
...
class BlueItAnnouncements extends Component
{
    ...
    public function mount(string $panelId): void
    {
        ...
        $this->pollSeconds = max(5, (int) config('minecrafttoolkit.blueit_announcements_poll_seconds', 10));
    }
        ...
        try {
            ...
            foreach ($this->popupAnnouncements as $announcement) {
                ...
                try {
                    ...
                    Log::debug('Minecraft Toolkit BlueIT announcement database notification failed.', [
            ...
            Log::debug('Minecraft Toolkit BlueIT announcement component failed to refresh.', [
                'exception' => $exception::class,
                'message' => $exception->getMessage(),
            ]);
            $this->popupAnnouncements = [];
    ...
    {
        return view('minecrafttoolkit::livewire.blueit-announcements');
    }
